...
import rental.me.Usuario.Seguridad.Servicios.UserDetailsServiceImp;
import rental.me.Usuario.Seguridad.jwt.AuthEntryPointJwt;
import rental.me.Usuario.Seguridad.jwt.AuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .authorizeRequests().antMatchers("/usr/auth/**").permitAll()
